...
function ChatIntcomex() {
    ...
    return(
        <>
        <div className="flex flex-row max-w-full tamano py-4 px-2 bg-zinc-300 rounded-lg lg:justify-center mt-20 mx-10">
                    ...
                    <div className="self-center min-w-[100px] mr-2">                    
                        <ul>
                        {
                            userChats?.map((chat,index)=>{
                                return(
                                    <li className="cursor-pointer w-full h-20 border  bg-white/80 rounded-lg text-black text-xs mb-4 py-0.4 self-center" key={index} onClick={()=> updateCurrentChat(chat)}>
